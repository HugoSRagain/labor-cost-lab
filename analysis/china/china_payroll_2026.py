...
PROVINCE_DATA_2026 = {
    "BJ": {"name_fr": "Pekin", "name_en": "Beijing", "population": 21830000,
           ...
           "hpf_base": _u(2540.0, 36348.0),
           "minimum_wage_monthly": 2540.0,
           "note": "Social-insurance and housing-fund contribution-base ceiling updated 2026-08-31 to the 2026/07-2027/06 cycle (floor 7,270 / cap 36,348), per the Beijing Human Resources and Social Security Bureau's notice published 21 August 2026."},
    ...
    "SH": {"name_fr": "Shanghai", "name_en": "Shanghai", "population": 24800000,
           "si_base": _u(7546.0, 37731.0),
           "pension": {"employer": 0.16, "employee": 0.08},
           "medical": {"employer": 0.095, "employee": 0.02},
           "unemployment": {"employer": 0.005, "employee": 0.005},
           "work_injury_employer": 0.002,
           "hpf_base": _u(2740.0, 37731.0),
           "minimum_wage_monthly": 2740.0,
           "note": "This module's reference wage anchor (see module docstring). Social-insurance and housing-fund contribution-base ceiling updated 2026-08-31 to the 2026/07-2027/06 cycle (floor 7,546 / cap 37,731, based on the 2025 average monthly wage of 12,577 RMB), per the Shanghai Human Resources and Social Security Bureau's notice published 18 August 2026."},
    ...
    "GD": {"name_fr": "Guangdong", "name_en": "Guangdong", "population": 127800000,
           ...
           "medical_base": _u(6234.0, 31170.0),
           "pension": {"employer": 0.16, "employee": 0.08},
           "medical": {"employer": 0.06, "employee": 0.02},
           ...
           "note": "Reference city: Guangzhou (provincial capital). The employer medical rate reverted from a temporary 4.5% relief rate back to the standard 6% effective 1 January 2026 (the relief measure ran 1 March 2024-31 December 2025 and was not renewed); Guangzhou's medical contribution base is also its own separate floor/cap (RMB 6,234-31,170/month for 2026), distinct from the pension/unemployment si_base. Shenzhen, in the same province, differs meaningfully: a hukou-dependent pension employer rate (16% or 17%), its own separate medical contribution base (RMB 6,733-33,666/month) and its own minimum wage (RMB 2,520/month) -- not modelled as a separate entry to keep this module at exactly 31 provincial divisions.",
           "confidence_note": "Employer medical rate and medical contribution base updated 2026-08-31 following confirmation of the 1 January 2026 reversion to 6%; source: Guangzhou Medical Insurance Bureau 2026 notice."},
