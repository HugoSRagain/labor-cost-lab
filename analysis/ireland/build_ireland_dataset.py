...
from paye_usc_prsi_2026 import compute_ireland_paye_usc_prsi_2026
...
OUTPUT_PATH = (
    ...
    / "data"
    / "ireland"
    / "ireland_labour_cost_grid_2026.csv"
)
...
def compute_row(
    ...
    result = compute_ireland_paye_usc_prsi_2026(gross_monthly_eur)

    income_tax_monthly = result["income_tax_monthly_eur"]
    usc_monthly = result["usc_monthly_eur"]
    employee_prsi = result["employee_prsi_monthly_eur"]
    employer_prsi = result["employer_prsi_monthly_eur"]

    employee_contributions = employee_prsi
    employer_contributions = employer_prsi

    net_before_income_tax = gross_monthly_eur - employee_contributions
    net_after_income_tax = net_before_income_tax - income_tax_monthly - usc_monthly
    ...
    return {
        ...
        "employee_prsi_monthly_eur": round_money(employee_prsi),
        "employer_prsi_monthly_eur": round_money(employer_prsi),
        ...
        "usc_monthly_eur": round_money(usc_monthly),
